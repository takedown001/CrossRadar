...
import com.Gcc.Magneto.SafeService;
import com.Gcc.Magneto.ShellUtils;
...
public class VeitnamFragment extends Fragment {
    ...
    String Antibanvn1 = urlref.mainurl+ "Antibanvn1.php";
    String Antibanvn2 = urlref.mainurl+ "Antibanvn2.php";
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        data =   reader.getUrlContents(Antibanvn1,params);
                        try {
        ...
        antiban2.setOnClickListener(new View.OnClickListener() {
            ...
            handler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    params.put(TAG_VERSION,version);
                    params.put(TAG_DEVICEID, deviceid);
                    data =   reader.getUrlContents(Antibanvn2,params);
                    try {
                        Process su = Runtime.getRuntime().exec("su");
                        DataOutputStream outputStream = new DataOutputStream(su.getOutputStream());
                        outputStream.writeBytes(data + "\n");
