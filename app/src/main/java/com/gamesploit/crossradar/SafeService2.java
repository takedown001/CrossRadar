...
public class SafeService2 extends Service {
    ...
    private void InitBaseView() {
        ...
        Switch bypassfireWALL = mainView.findViewById(R.id.bypassfirewall);
        bypassfireWALL.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener(){
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                if (isChecked){
    ...
    public void onCreate() {
        ...
        hexdaemon = getFilesDir().getPath() + "/libPOST.so";
